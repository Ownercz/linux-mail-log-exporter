#!/usr/bin/env python
#taken from: https://askubuntu.com/questions/780601/how-to-monitor-syslog-and-get-alerted-when-there-is-a-certain-entry
...
def action():
    ...
    if 'notify' in sys.argv:
        ...
        subprocess.Popen(['touch', '/tmp/maillog.error'])
